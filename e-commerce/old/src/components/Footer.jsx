    ...
    return (
        <footer className="footerConDiv">
            <div className="footSubs d-flex justify-content-around align-items-center py-5">
                <div><h1>Subscribe newsletter</h1></div>
                <div><input type="email" placeholder="Email address" /></div>
                <a className="sendBtn"> <i class="bi-send"></i></a>
            ...
            <div className="d-flex justify-content-between py-5">
                <div className="col-2">
                    ...
                    <p className="py-4">64 st james boulevard <br />
                        hoswick , ze2 7zj</p><hr />
                ...
                <FooterList FindData={FindData} />
                <FooterList FindData={FindData} />
                <FooterList FindData={FindData} />
                {/* <FooterList GetData={GetData} /> */}
                {/* <FooterList AboutData={AboutData} /> */}
            </div>
        </footer>
    )
}